  ...
  return (
    <Html>
      <Head>
        ...
        <meta name="application-name" content="Brainwave.ai" />
        <meta name="apple-mobile-web-app-capable" content="yes" />
        <meta name="apple-mobile-web-app-status-bar-style" content="default" />
        <meta name="apple-mobile-web-app-title" content="Brainwave.ai" />
        ...
        <meta name="description" content="Brainwave.ai self-hosted personal note" />
