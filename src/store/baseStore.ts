  ...
  useInitApp(router) {
    ...
    useEffect(() => {
      if (router.pathname == '/review') {
        ...
        this.currentTitle = 'Detail View';
      } else if (router.query?.path == 'all') {
        this.currentTitle = t('All Entries');
      } else if (router.query?.path == 'notes') {
        this.currentTitle = 'Deep Insights';
      } else if (router.query?.path == 'archived') {
        this.currentTitle = 'Archived Records';
      } else if (router.pathname == '/resources') {
        this.currentTitle = 'Knowledge Base';
      } else if (router.query?.path == 'trash') {
        this.currentTitle = 'trash';
      } else if (router.pathname == '/plugin') {
        this.currentTitle = 'AI Extensions';
      } else if (router.pathname == '/') {
        this.currentTitle = 'Quick Capture';
      } else {
